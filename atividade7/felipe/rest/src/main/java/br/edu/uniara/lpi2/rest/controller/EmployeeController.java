...
public class EmployeeController {
    ...
    public Employee one(@PathVariable Long id) {
        return repository.findById(id).orElseThrow(() -> new RuntimeException("Erro pesquisando id: " + id));
    }
    ...
    public ResponseEntity<?> all(@RequestParam int page, @RequestParam int size) {
        ...
        final Page<Employee> listEmployee = pagingRepository.findAll(pageable);
